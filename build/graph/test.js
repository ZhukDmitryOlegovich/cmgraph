...
const c1 = new PIXI.GraphicsData(new PIXI.Circle(0, 0, 50), createFillStyle({ color: 0x0000FF, alpha: 0.5 }), createLineStyle({ width: 1 }));
const c2 = new PIXI.GraphicsData(new PIXI.Circle(100, 0, 50), createFillStyle({ color: 0x00FF00, alpha: 0.5 }), c1.lineStyle);
...
const sc = new PIXI.GraphicsData(new PIXI.Circle(-20, 0, 10), createFillStyle({ color: Color('red'), alpha: 0.5 }), createLineStyle({
    color: Color('black'), width: 1, alpha: 1,
}));
const mc = new PIXI.GraphicsData(new PIXI.Circle(10, 0, 20), createFillStyle({ color: Color('green'), alpha: 0.5 }), createLineStyle({
    color: Color('black'), width: 1, alpha: 1,
}));
const lc = new PIXI.GraphicsData(new PIXI.Circle(0, 0, 30), createFillStyle({ color: Color('green'), alpha: 0.5 }), createLineStyle({
    color: Color('black'), width: 1, alpha: 1,
}));
// mc.holes = [sc];
lc.holes = [mc, sc];
